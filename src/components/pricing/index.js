  ...
  const faqArr = [
      ...
      a: (
        ...
        >
          <p>
            ...
            from a standalone point of view but focus on the overall outcome our
            design products generate. Here’s what we mean by basic design
          </p>
          <ul>
    ...
    },
    {
      ...
      a: (
        ...
        >
          <p>
            We can help guide you! Just book a call with us and we'll figure it
            out based on your team's needs. Let's find the best option,
            together.
          </p>
        </div>
      ),
    },
    {
      ...
      a: (
        ...
        >
          <p>
            We offer credit card billing or invoicing depending on the plan you
            choose.
          </p>
        </div>
      ),
      ...
      a: (
        ...
        >
          <p>
            ...
            requested for. This is done to protect their confidentiality, trade
            secrets and business information. We understand the roles and
            responsibilities working for our clients behind the scenes.
          </p>
        </div>
      ),
    },
    {
      q: (
        <div className={styles.question} onClick={() => setActive(active === 6 ? 0 : 6)}>
          <p>What happens in case of unavailability of my resource?</p>
          <img
            className={active === 6 && styles.rotate}
            src="https://firebasestorage.googleapis.com/v0/b/cliqtick.appspot.com/o/ststicV2%2Fdrop.png?alt=media&token=0db2857d-4f5b-4884-a17f-b53bfb970d30"
            alt="arrow"
          />
        </div>
      ...
      a: (
        ...
        >
          <p>
            All leaves and offs are planned well in advance and communicated to
            our clients accordingly. We avoid unavailability of resources for
            petty reasons that can hamper schedule. In case of health and other
            emergency leaves a suitable replacement to best suit the needs of
            our clients is made available.
          </p>
        </div>
      ),
    },
    {
      q: (
        <div className={styles.question} onClick={() => setActive(active === 7 ? 0 : 7)}>
          <p>How do you ensure quality resources to meet our requirements?</p>
          <img
            className={active === 7 && styles.rotate}
            src="https://firebasestorage.googleapis.com/v0/b/cliqtick.appspot.com/o/ststicV2%2Fdrop.png?alt=media&token=0db2857d-4f5b-4884-a17f-b53bfb970d30"
            alt="arrow"
          />
        </div>
      ...
      a: (
        ...
        >
          <p>
            ...
            tests, we provide the best candidates to meet the niche requirements
            of the clients.
          </p>
        </div>
      ),
      ...
      <section className={styles.pricing} ref={pricingRef}>
        ...
        <div className={styles.containerHead}>
          ...
          <div>
            ...
            <p>
              dedicated social media teams, video production teams and stellar
              support
            </p>
          </div>
        </div>
          ...
          <div className={styles.price}>
            ...
            <div className={`${styles.item} ${styles.margin10}`}>
              <img
                ...
                alt="tick"
              />
              <p>Covers Basic graphic and presentation design</p>
            </div>
            <div className={`${styles.item} ${styles.margin10}`}>
              <img
                src="https://firebasestorage.googleapis.com/v0/b/cliqtick.appspot.com/o/ststicV2%2Ftick.png?alt=media&token=72279fb5-7ae3-45ab-a5da-321f065c3416"
            ...
            <p className={styles.bookNow} onClick={handleBooknow}>
              Book Now
            </p>
          </div>
          <div className={styles.price}>
